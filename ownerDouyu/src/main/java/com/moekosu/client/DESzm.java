package com.ejoined.dmp.portal.common.utils;
...
//	private static String strDefaultKey = "12345678";
	private static String strDefaultKey = "43659876"; //生产用
	...
	**************************************************************************/
	...
	public String Decode(String str) {
	   ...
	   DESzm m = new DESzm();
	   byteMiW = m.hexStr2ByteArr(str);

	   i2 = m.DECRYPT(m.strDefaultKey.getBytes(), byteMingW, byteMiW,
	     byteMiW.length);
